  ...
  return (
    ...
    >
      ...
      {ctx.isChallengeMode && ctx.selectedChallengeAccount && (
        <View style={[styles.challengeInfoBar, { backgroundColor: colors.bgCard, borderColor: '#2563eb' }]}>
          ...
          >
            ...
            <View style={[styles.challengeBadge, { 
              backgroundColor: ctx.selectedChallengeAccount.status === 'ACTIVE' ? '#22c55e20' : 
                              ctx.selectedChallengeAccount.status === 'PASSED' ? '#2563eb20' : '#ef444420' 
            }]}>
              <Text style={[styles.challengeBadgeText, { 
                color: ctx.selectedChallengeAccount.status === 'ACTIVE' ? '#22c55e' : 
                       ctx.selectedChallengeAccount.status === 'PASSED' ? '#2563eb' : '#ef4444' 
              }]}>
      ...
      {!ctx.isChallengeMode && ctx.selectedAccount && (
        <View style={[styles.accountCard, { backgroundColor: colors.bgCard, borderColor: '#2563eb', borderWidth: 2 }]}>
